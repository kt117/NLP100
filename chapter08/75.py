...
sns.lineplot(x=[i for i in range(epochs)], y=[r[0] for r in train_results])
sns.lineplot(x=[i for i in range(epochs)], y=[r[0] for r in test_results])
plt.savefig('chapter08/outputs/75_loss.png')

plt.figure()

sns.lineplot(x=[i for i in range(epochs)], y=[r[1] for r in train_results])
sns.lineplot(x=[i for i in range(epochs)], y=[r[1] for r in test_results])
plt.savefig('chapter08/outputs/75_precision.png')
